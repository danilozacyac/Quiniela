...
public partial class MR2 : Telerik.Web.UI.RadAjaxPage// System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            idUsuario = "select Fecha,Local,Visitante,Ganador, Marcador, PuntosGanados,TipoAcierto from PronosticosUsuario WHERE IdTorneo = 2 AND IdUsuario = " + Session["IdUsuario"].ToString();
            DataBind();
        }
    }
